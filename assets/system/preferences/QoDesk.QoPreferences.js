...
QoDesk.QoPreferences = Ext.extend(Ext.app.Module, {
    ...
    requires: [
        'app/system/preferences/lib/Appearance',
        'app/system/preferences/lib/AutoRun',
        'app/system/preferences/lib/Background',
        'app/system/preferences/lib/CheckTree',
        'app/system/preferences/lib/Grid',
        'app/system/preferences/lib/Nav',
        'app/system/preferences/lib/QuickStart',
        'app/system/preferences/lib/Shortcuts'
    ],
