QoDesk.BogusWindow = Ext.extend(Ext.app.Module, {
    id: 'demo-bogus',
    type: 'coralmediawebdesktop/demo/bogus',
    detailModule: null,
    ...
    createWindow: function () {
        ...
        let win = desktop.getWindow('bogus-win');
    ...
    showDialog: function () {
        let winManager = this.app.getDesktop().getManager();
...
Ext.extend(QoDesk.BogusWindow.NavPanel, Ext.Panel, {
    ...
    doAction: function (e, t) {
        let self = this;
        e.stopEvent();
        self.actions[t.id](this.owner); // pass owner for scope
    }
});
...
BogusDetailModule = Ext.extend(Ext.app.Module, {
    ...
    createWindow: function (app, id) {
        ...
        let desktop = app.getDesktop();
        let win = desktop.getWindow('bogus-detail' + id);
