...
CoralMedia.Admin = Ext.extend(Ext.app.Module, {
    ...
    type: 'coralmediawebdesktop/system/administration',
    requires: [
        'app/coralmediawebdesktop/system/administration/lib/CoralMedia.Admin.Nav',
        'app/coralmediawebdesktop/system/administration/lib/user/CoralMedia.Admin.User.TooltipEditor',
        'app/coralmediawebdesktop/system/administration/lib/user/CoralMedia.Admin.User.Grid',
        'app/coralmediawebdesktop/system/administration/lib/user/CoralMedia.Admin.User.Form',
        'app/coralmediawebdesktop/system/administration/lib/group/CoralMedia.Admin.Group.Grid',
        'app/coralmediawebdesktop/system/administration/lib/group/CoralMedia.Admin.Group.Form'
    ],
    addons: [
        'hydra-api',
        'superbox-select',
